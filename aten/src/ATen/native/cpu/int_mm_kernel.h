...
using dyn_quant_pack_4bit_weight_fn = void (*)(Tensor&, const Tensor&, const Tensor&, const Tensor&, const int64_t , const int64_t, const int64_t);
using dyn_quant_matmul_4bit_fn = void (*)(const Tensor&, const Tensor&, const Tensor&, const Tensor&, const Tensor&, const int64_t, const int64_t, const int64_t, const int64_t);
...
DECLARE_DISPATCH(dyn_quant_pack_4bit_weight_fn, dyn_quant_pack_4bit_weight_stub);
